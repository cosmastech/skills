...
Use `Partial` only when partiality is the actual domain concept. Define explicit operation inputs otherwise.
...
- optionality is resolved before required calls, and each `Partial` represents actual domain partiality;
