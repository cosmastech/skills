...
A genuinely unknown schema-owned boundary remains legitimate; the goal is to preserve provenance, not disguise unknown input to satisfy syntax-only lint.
...
2. Standard Schema compatibility for generic helpers;
3. Zod 4 otherwise;
4. a hand-written smart constructor/parser when it is clearer for a small domain type.
