...
Apply [`errors.md`](errors.md) to configuration failures and [`sensitive-data-and-observability.md`](sensitive-data-and-observability.md) to credentials and other sensitive configuration.
